...
*/
	...
	CXTPDockingPane* pPaneTree = m_paneManager.CreatePane(
		IDR_PANE_FILEVIEW, CRect(0, 0,300, 120), xtpPaneDockLeft);
...
LRESULT CMainFrame::OnDockingPaneNotify(WPARAM wParam, LPARAM lParam)
{
	if (wParam == XTP_DPN_SHOWWINDOW)
	{
		...
		if (!pPane->IsValid())
		{
			switch (pPane->GetID())
			{
			case IDR_PANE_FILEVIEW:
				pPane->Attach(&config->g_pView->m_wndTreeView);
			}
		}
		return TRUE;
	}
